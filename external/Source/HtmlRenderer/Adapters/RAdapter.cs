...
namespace TheArtOfDev.HtmlRenderer.Adapters
{
    ...
    public abstract class RAdapter
    {
        ...
        public RImage ImageFromStream(Stream memoryStream, int maxheight = 400)
        {
            return ImageFromStreamInt(memoryStream,maxheight);
        }
        ...
        /// <param name="memoryStream">the stream to create image from</param>
        /// <returns>new image instance</returns>
        protected abstract RImage ImageFromStreamInt(Stream memoryStream, int maxheight = 400);
